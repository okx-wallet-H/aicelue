...
OKX Agent TradeKit 交易赛 AI 策略引擎 —— AI 唯一决策、4 小时 UTC 整点调度、执行与风控闭环系统。
...
| 模块 | 文件 | 功能 |
|------|------|------|
| 调度引擎 | `run_engine.py` | 严格对齐 UTC 4 小时整点，且只允许单实例运行 |
...
- 止损兜底：止损挂单失败立即反向市价强平
- 调度要求：仅在 UTC 00:00 / 04:00 / 08:00 / 12:00 / 16:00 / 20:00 执行
